                ...
                <div class="col-md-6">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Perhitungan Pemilihan Sepeda Motor
                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div>
                                            <select name="bobot_harga" class="form-control">
                                                <option value="0.4">Sangat Rendah</option>
                                                <option value="0.3">Rendah</option>
                                                <option value="0.2">Cukup</option>
                                                <option value="0.1">Tinggi</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label>C2. Performa</label>
                                        <div>
                                            <select name="bobot_performa" class="form-control">
                                                <option value="0.10">Sangat Rendah</option>
                                                <option value="0.15">Rendah</option>
                                                <option value="0.20">Cukup</option>
                                                <option value="0.25">Tinggi</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label>C3. Bahan Bakar</label>
                                        <div>
                                            <select name="bobot_bahan_bakar" class="form-control">
                                                ...
                                                <option value="0.20">Tinggi</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label>C4. Desain</label>
                                        <div>
                                            <select name="bobot_desain" class="form-control">
                                                <option value="0.03">Sangat Rendah</option>
                                                <option value="0.07">Rendah</option>
                                                <option value="0.11">Cukup</option>

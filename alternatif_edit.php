        ...
        <div id="page-wrapper" class="page-wrapper-cls">
            <div id="page-inner">
                ...
                if (isset($_POST['update'])) {
                    ...
                    $result = mysqli_query($connect, "UPDATE alternatifhp SET merk_hp='$merek', thn_hp='$thn' WHERE idhp=$ids");
                ...
                <div class="col-md-6">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            $result = mysqli_query($connect, "SELECT * FROM alternatifhp WHERE idhp='$_GET[idhp]'") or die(mysqli_error($connect));
                            ...
                            <form action="alternatif_edit.php" method="post" name="form1">
                                <table width="25%" border="0">
                                    ...
                                    <div class="form-group">
                                        <label>Merek Sepeda Motor</label>
